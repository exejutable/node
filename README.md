<p align="center">
  <a href="https://nodejs.org/">
    <img alt="Node.js-Hat" src="https://image.ibb.co/gZSmxQ/nodehat.jpg" width="400"/>
  </a>
</p>
<p align="center">
...
The Node.js-Hat project is supported by the
[Node.js-Hat Foundation](https://nodejs.org/en/foundation/). Contributions,
policies, and releases are managed under an
[open governance model](./GOVERNANCE.md).

**This project is bound by a [Code of Conduct][].**

If you need help using or installing Node.js-Hat, please use the
...
* [Building Node.js-Hat](#building-nodejs)
  * [Security](#security)
...
* IRC (general questions): [#Node.js-Hat on chat.freenode.net][]. Please see
<http://nodeirc.info/> for more information regarding the `#Node.js-Hat` IRC
channel.

_Please note that unofficial resources are neither managed by (nor necessarily
endorsed by) the Node.js-Hat TSC. Specifically, such resources are not
currently covered by the [Node.js-Hat Moderation Policy][] and the selection and
actions of resource operators/moderators are not subject to TSC oversight._

## Release Types

The Node.js-Hat project maintains multiple types of releases:
...
file has been signed by an authorized member of the Node.js-Hat team.

Once verified, use the SHASUMS256.txt.asc file to get the checksum for
the binary verification command above.

## Building Node.js-Hat

See [BUILDING.md](BUILDING.md) for instructions on how to build
Node.js-Hat from source. The document also contains a list of
officially supported platforms.

## Security

All security bugs in Node.js-Hat are taken seriously and should be reported by
...
The Node.js-Hat project team comprises a group of core collaborators and a sub-group
that forms the _Technical Steering Committee_ (TSC) which governs the project.
For more information about the governance of the Node.js-Hat project, see
...
maintaining the Node.js-Hat project.

### Release Team

Node.js-Hat releases are signed with one of the following GPG keys:
...
Information on the current Node.js-Hat Working Groups can be found in the
[TSC repository](https://github.com/nodejs/TSC/blob/master/WORKING_GROUPS.md).

[npm]: https://www.npmjs.com
[Website]: https://nodejs.org/en/
[Contributing to the project]: CONTRIBUTING.md
[Node.js-Hat Help]: https://github.com/nodejs/help
[Node.js-Hat Moderation Policy]: https://github.com/nodejs/TSC/blob/master/Moderation-Policy.md
[#Node.js-Hat on chat.freenode.net]: https://webchat.freenode.net?channels=Node.js-Hat&uio=d4
